...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr class="ct_list_pop">
		...
		<td></td>
		<td align="left"><a href="../product/getProduct?prodNo=<%=vo.getProdNo() %>"><%=vo.getProdNo() %></a></td>
		<td></td>
	...
	<tr class="ct_list_pop">
		...
		<td></td>
				...
				<td align="left"><a href="../product/getProduct?prodNo=${i.prodNo}&menu=${param.menu}">${i.prodName}</a></td>
